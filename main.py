...
#----------Pantalla---------------
#Valor que se ingresa por Pantalla
numeroPantalla=StringVar(value="0")

pantalla=Entry(miFrame,textvariable=numeroPantalla)
pantalla.grid(row=1,column=1,padx=20,pady=20,columnspan=4)
pantalla.config(background="black",fg="#03f943",justify="right")

#-------Pulsaciones realizadas---------
#Se tiene encuenta que operacion inicialmente es  = ""
...
botonDiv=Button(miFrame,text="/",width=9,command=lambda:divide(numeroPantalla.get()))
...
botonMult=Button(miFrame,text="x",width=9,command=lambda:multiplica(numeroPantalla.get()))
...
botonRest=Button(miFrame,text="-",width=9,command=lambda:resta(numeroPantalla.get()))
...
botonIgual=Button(miFrame,text="=",width=9,command=lambda:el_resultado())
botonIgual.grid(row=5,column=3)
botonSuma=Button(miFrame,text="+",width=9,command=lambda:suma(numeroPantalla.get()))
